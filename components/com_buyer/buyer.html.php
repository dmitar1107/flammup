...
*/
class HTML_buyer {
	function browseauctions($cpage, $pages) {
		global $Config_live_site;
	?>
	
	<script type="text/javascript">
		$(document).ready( function () {
		var real_page = "<?php echo $cpage;?>";
...
//			setInterval(load(), 1000);
			function load() {
				$("#listview").load("index.php?option=buyer&page=browseauctions&content=1&cpage="+real_page+"&pages=<?php echo $pages?>", hideLoader);
			}
			function showLoader(){
...
<?php
	if (isset($_SESSION["user_id"]) ==  "1") {
		echo "<div class='notify'>Welcome, you just earned 700 flames</div>";
		echo "<div class='notify' style='cursor:pointer;' id='knowmore'>Know more</div>";
	}
	else {
		echo "<div class='notify'>Welcome, you just earned 700 flames</div>";
		echo "<div class='notify' style='cursor:pointer;'>Know more</div>";
	}

	echo '<div class="search-background"><label><img src="'.$Config_live_site.'/images/loader.gif" alt="" /></label></div>';
...
//			echo "<li><div class='list_content'></div><a href='#'>Home</a></li>";					
//		}
//		echo "</ul>";
	echo "</div>";
	echo "<div id='navigator' align='center'>";
		echo "<img src='".$Config_live_site."/images/down.png' id='down'/>";
		echo "<img src='".$Config_live_site."/images/up.png' id='up'/>";
	echo "</div>";
		echo "<div id='bottom'>";
//		print_r(isset($_SESSION["user_id"]));exit;

	if (isset($_SESSION["user_id"]) ==  "1") {
		echo "<a href='index.php?task=logout&option=buyer&page=browseauctions' id='logout' class='b_bottom'>Logout</a>";
	}
	else {
		echo "<a href='index.php?option=login' id='b_login' class='b_bottom'>login</a>";
		echo "<a href='index.php?option=register' id='b_register' class='b_bottom'>Register</a>";
	}
	echo "</div>";
?>
<?php
