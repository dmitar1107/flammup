...
?>
<form name='seller_menu' id='seller_menu' action="" method="post">
<div  id="seller_menu">
	<div class="navigater" align="center">
		<?php
			echo "<img src='".$Config_live_site."/images/up.png' id='up'/></div>";
			for($i = 0; $i <count($menus); $i++) {
				echo "<p class='menus' id='".$menus[$i]->url."'>".$menus[$i]->name."</p>";
			}	
		?>
			<div class="navigater" align="center">
		<?php
			echo "<img src='".$Config_live_site."/images/down.png' id='down'/></div>";
		?>
...
<script>
	$(document).ready( function  () {
		...
		fullHeight = fullHeight + scrollTop*2;
		var width = parseInt($("#seller_menu").css("width"));
		var height = parseInt($("#seller_menu").css("height"));
		var realLeft = (fullWidth - width)/2;
		var realTop = (fullHeight - height)/2;
		$("#seller_menu").css("left",realLeft);
		$("#seller_menu").css("top",realTop);
		
		$("#myauction").bind("click", function () {
			document.location.href = "index.php?option=seller&page=myauction";
		});
	});
...
function buyer_menu ($menus) {
	GLOBAL $Config_live_site;
	?>
	<form name='buyer_menu' id='buyer_menu' action="" method="post">

	<div  id="seller_menu" align="center">
		<div class="navigater" >
		<?php
		echo "<img src='".$Config_live_site."/images/up.png' id='up'/></div>";
	...
	<script>
		$(document).ready( function  () {
			...
			$("#browseauctions").bind("click", function () {
				document.location.href = "index.php?option=buyer&page=browseauctions";
			});
		});
