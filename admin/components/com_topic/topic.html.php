<?php
/**
* @version $Id: topic.html.php 10002 2008-02-08 10:56:57Z willebil $
* @package Joomla
* @subpackage Topic
...
class HTML_topic {
	...
	function showTopic( &$rows, $pageNav, $search, $option, $lists ) {
		?>
		...
		for ($i=0, $n=count( $rows ); $i < $n; $i++) {
			...
			$link 	= 'index.php?option=com_topic&amp;task=editA&amp;id='. $row->id. '&amp;hidemainmenu=1';
			?>
	...
	function editTopic( &$row, &$lists, $option, $uid ) {
		...
		<tr>
			<th class="user">
			Topic: <small><?php echo $row->id ? 'Edit' : 'Add';?></small>
			</th>
		</tr>
		</table>
