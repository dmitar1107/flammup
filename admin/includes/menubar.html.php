...
class mosMenuBar {
	...
	*/
	function custom( $task='', $icon='', $iconOver='', $alt='', $listSelect=true ) {
		...
		$image 	= mosAdminMenus::ImageCheckAdmin( $icon, '/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
	...
	*/
	function addNew( $task='new', $alt='New' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'new_f2.png', '/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
	...
	*/
	function publish( $task='publish', $alt='Publish' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'publish_f2.png', '/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
			<a class="toolbar" href="javascript:submitbutton('<?php echo $task;?>');">
				<?php echo $image2; ?>
	...
	*/
	...
	/**
	* Writes a common 'recommend' button for a list of records
	* @param string An override for the task
	* @param string An override for the alt text
	*/
	function recommendList( $task='recommend', $alt='推荐' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'publish_f2.png', '/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
	 	<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Please make a selection from the list to recommend'); } else {submitbutton('<?php echo $task;?>', '');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
	 	<?php
	...
	*/
	function unpublish( $task='unpublish', $alt='Unpublish' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'unpublish_f2.png', '/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
			<a class="toolbar" href="javascript:submitbutton('<?php echo $task;?>');">
				<?php echo $image2; ?>
	...
	*/
	...
	/**
	* Writes a common 'unrecommend' button for a list of records
	* @param string An override for the task
	* @param string An override for the alt text
	*/
	function unrecommendList( $task='unrecommend', $alt='不推荐' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'unpublish_f2.png', '/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Please make a selection from the list to unrecommend'); } else {submitbutton('<?php echo $task;?>', '');}">
				<?php echo $image2; ?>
				<br /><?php echo $alt; ?></a>
		</td>
		<?php
	...
	*/
	function archiveList( $task='archive', $alt='Archive' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'archive_f2.png', '/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
	...
	*/
	function unarchiveList( $task='unarchive', $alt='Unarchive' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'unarchive_f2.png', '/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
	...
	*/
	function editList( $task='edit', $alt='Edit' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'edit_f2.png', '/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
	...
	*/
	function editHtml( $task='edit_source', $alt='Edit&nbsp;HTML' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'html_f2.png', '/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Please select an item from the list to edit'); } else {submitbutton('<?php echo $task;?>', '');}">
				<?php echo $image2; ?>
	...
	*/
	function editCss( $task='edit_css', $alt='Edit&nbsp;CSS' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'css_f2.png', '/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
			<a class="toolbar" href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Please select an item from the list to edit'); } else {submitbutton('<?php echo $task;?>', '');}"">
				<?php echo $image2; ?>
	...
	*/
	function deleteList( $msg='', $task='remove', $alt='Delete' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'delete_f2.png', '/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
	...
	*/
	function preview( $popup='', $updateEditors=false ) {
		global $database;
		$image2 = mosAdminMenus::ImageCheckAdmin( 'preview_f2.png', '/images/', NULL, NULL, 'Preview', 'preview', 1, 'middle', 'Preview' );
	...
	*/
	function help( $ref, $com=false ) {
		...
		$image2 	= mosAdminMenus::ImageCheckAdmin( 'help_f2.png', '/images/', NULL, NULL, 'Help', 'help', 1, 'middle', 'Help' );
	   ...
	   // help file for 3PD Components
			$url = $mosConfig_live_site . '/components/' . $GLOBALS['option'] . '/help/';
	   ...
	   // Online help site as defined in GC
			...
			$url = $helpUrl . '/index.php?option=com_content&amp;task=findkey&amp;pop=1&amp;keyref=' . urlencode( $ref );
		} else {
	...
	*/
	function apply( $task='apply', $alt='Apply' ) {
		...
		$image2 = mosAdminMenus::ImageCheckAdmin( 'apply_f2.png', '/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
			<a class="toolbar" href="javascript:submitbutton('<?php echo $task;?>');">
				<?php echo $image2; ?>
	...
	*/
	function save( $task='save', $alt='Save' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'save_f2.png', '/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
			<a class="toolbar" href="javascript:submitbutton('<?php echo $task;?>');">
				<?php echo $image2; ?>
	...
	*/
	function cancel( $task='cancel', $alt='Cancel' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'cancel_f2.png', '/images/', NULL, NULL, $alt, $task, 1, 'middle', $alt );
		?>
		<td>
			<a class="toolbar" href="javascript:submitbutton('<?php echo $task;?>');">
				<?php echo $image2; ?>
	...
	*/
	function back( $alt='Back', $href='' ) {
		$image2 = mosAdminMenus::ImageCheckAdmin( 'back_f2.png', '/images/', NULL, NULL, 'back', 'cancel', 1, 'middle', $alt );
		if ( $href ) {
			$link = $href;
		} else {
